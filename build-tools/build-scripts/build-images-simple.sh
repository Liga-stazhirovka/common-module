...
pull_or_clone_proj common-module https://github.com/orgs/Liga-stazhirovka/repositories/common-module.git
pull_or_clone_proj medical-monitoring https://github.com/orgs/Liga-stazhirovka/repositories/medical-monitoring.git
pull_or_clone_proj message-analyzer https://github.com/orgs/Liga-stazhirovka/repositories/message-analyzer.git
pull_or_clone_proj person-service https://github.com/orgs/Liga-stazhirovka/repositories/person-service.git
